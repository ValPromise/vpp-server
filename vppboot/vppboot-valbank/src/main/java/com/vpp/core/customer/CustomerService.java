...
public class CustomerService implements ICustomerService {
	...
	public static final String VALBANK_ETH_OPEN_VALUE_KEY = "valbank_eth_open_value_key";
	public static final int VALBANK_ETH_OPEN_VALUE_KEY_TIME = 10; //10秒
	public static final String VALBANK_FROM_USD_TO_CNY_KEY = "valbank_from_usd_to_cny_key"; 
	public static final int VALBANK_FROM_USD_TO_CNY_KEY_TIME = 60*60; //1小时
	...
	public Double getEthOpenValue(){
		Double openValue = 0D;
		try {
			String  ethOpenValue  = customerServiceRedis.opsForValue().get(VALBANK_ETH_OPEN_VALUE_KEY);
			if(StringUtils.isEmpty(ethOpenValue)){
				...
				customerServiceRedis.opsForValue().set(VALBANK_ETH_OPEN_VALUE_KEY,openValue.toString(),VALBANK_ETH_OPEN_VALUE_KEY_TIME,TimeUnit.SECONDS);
			}else{
	...
	public Double getFromUsdToCny(){
		Double result = 0D;
		try {
			String  cnyValue   = customerServiceRedis.opsForValue().get(VALBANK_FROM_USD_TO_CNY_KEY);
			if(StringUtils.isEmpty(cnyValue)){
			    ...
			    result =value/100;
			    customerServiceRedis.opsForValue().set(VALBANK_FROM_USD_TO_CNY_KEY,result.toString(),VALBANK_FROM_USD_TO_CNY_KEY_TIME,TimeUnit.SECONDS);
			}else{
