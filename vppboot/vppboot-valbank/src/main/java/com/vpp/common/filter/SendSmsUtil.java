...
//       request.setOutId("yourOutId");
     ...
     * @return
     */
   /* public static String sendSmsIntl(String mobile,String mobileCode){
    	String msg ="【vpp】您的验证码是："+mobileCode;
    	String resultValue = "";
		try {
			//组装请求参数
			JSONObject map=new JSONObject();
			map.put("account", ACCOUNT_INTL);
			map.put("password", PASSWORD_INTL);
			map.put("msg", msg);
			map.put("mobile", mobile); 
			String params =map.toString(); 
			logger.info("请求参数为:" + params);
			String result=HttpUtil.post(CHUANG_LAN_URL_CH_URL_INTL,params);
